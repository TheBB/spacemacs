...
* Description
ES6 and JSX ready configuration layer for React. It will automatically recognize
=.jsx= and =.react.js= files
...
try out this one by Airbnb: [[https://github.com/airbnb/javascript/blob/master/linters/.eslintrc][.eslintrc]]
