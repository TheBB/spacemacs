...
** How to install
In your =~/.spacemacs= file in the function =dotspacemacs/layers=, the variable
=dotspacemacs-configuration-layers= is set. To enable a layer, simply add it to
this list. The code looks like this.
...
Some layers have special variables that you might like to change. To do this,
